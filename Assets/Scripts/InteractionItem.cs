...
namespace Construct.Interaction
{
    ...
    public class InteractionItem : MonoBehaviour
    {
        ...
        {
            Debug.Log("<b>[Construct]</b> Pickup: " + transform.name);
            ...
            InstructorController.Instance.ReceiveTask(0);
        }
        ...
        {
            Debug.Log("<b>[Construct]</b> Detach: " + transform.name);
            attached = false;
            ...
            InstructorController.Instance.ReceiveTask(1);
        }
